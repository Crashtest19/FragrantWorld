...
namespace FragrantWorld.Database;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Database=FragrantWorld;Trusted_Connection=True; TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ManufacturerId).HasName("PK__Manufact__357E5CC1445B5291");
        ...
        {
            entity.HasKey(e => new { e.OrderProductId, e.ProductArticleNumber }).HasName("PK__OrderPro__6B5A640F381539AE");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__ProductC__19093A0B9101E8FA");
